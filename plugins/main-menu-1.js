...
//==============> Menu nya
let intro = `*ʙᴏᴛ* sa kreye pa andymrlit so siw ta jwenn on bug klike sou owner a pou signaler bug la pou l ka ranje ou menm ki ta renmen mete bot la sou whatsapp ou poul k jere group pou ou ak plizye lot bagy kontakte andy epi lap diw sa ap bezwen pou w fè sa antooka map profite diw pa use bot la san w pa bezwen poul pa ban ou_`
...
function ucapan() {
  ...
  let res = "Il est tôt, pourquoi n'as-tu pas encore dormi soeurette? 🥱"
  if (time >= 4) {
    res = "Pagi Lord 🌄"
  }
  if (time >= 10) {
